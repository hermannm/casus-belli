...
var Games = map[string]gameserver.GameConstructor{
...
func gameConstructor(boardName string) gameserver.GameConstructor {
	return func(lob gameserver.Lobby, options any) (gameserver.Game, error) {
