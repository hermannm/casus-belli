...
public static class Scenes
{
    ...
    public const string MessageDisplay = "res://scenes/components/message_display.tscn";
    public const string ErrorMessage = "res://scenes/components/error_message.tscn";
}
